  ...
  return (
    <section className={`pt-6 md:pt-8 lg:pt-10 pb-12 md:pb-16 lg:pb-6 bg-gradient-to-br from-white via-gray-50/50 to-white relative overflow-hidden ${className}`}>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl relative z-10">
        ...
        {/* Main Content Grid: Form (Left) + Scheduler (Right) */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">

          {/* LEFT COLUMN: Contact Form */}
          <div
            className="relative rounded-2xl p-6 sm:p-8 bg-white border border-gray-100 shadow-xl h-full"
            style={{
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label htmlFor="email" className="block text-sm font-semibold text-gray-700 mb-1.5">
                    Your Email <span className="text-[#CA1411]">*</span>
                  </label>
                  <input
                    type="email"
                    id="email"
                ...
                <div>
                  <label htmlFor="phone" className="block text-sm font-semibold text-gray-700 mb-1.5">
                    Phone Number <span className="text-[#CA1411]">*</span>
                  </label>
                  <input
                    type="tel"
                    id="phone"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  <label htmlFor="numberOfSeats" className="block text-sm font-semibold text-gray-700 mb-1.5">
                    No. of Seats <span className="text-[#CA1411]">*</span>
                  </label>
                  <input
                    type="number"
                    id="numberOfSeats"
              ...
              {/* Remarks / Message */}
              <div>
                <label htmlFor="remarks" className="block text-sm font-semibold text-gray-700 mb-1.5">
              ...
              <div className="pt-2">
                <button
                  type="submit"
                  disabled={submitting}
                  className="w-full px-8 py-3.5 bg-[#CA1411] hover:bg-[#B0120F] text-white font-semibold rounded-lg transition-all duration-300 shadow-lg hover:shadow-xl hover:-translate-y-0.5 text-base md:text-lg disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {submitting ? 'Sending Request...' : buttonText}
                </button>
              </div>
            </form>
          </div>
          ...
          <div
            className="relative rounded-2xl p-6 sm:p-8 bg-white border border-gray-100 shadow-xl h-full flex flex-col"
            style={{
              background: 'linear-gradient(to bottom, rgba(255, 255, 255, 0.95), rgba(255, 255, 255, 0.9))',
              backdropFilter: 'blur(20px) saturate(180%)',
              WebkitBackdropFilter: 'blur(20px) saturate(180%)',
