...
export const teamMembersData: TeamMember[] = [
  ...
  },
  {
    ...
    image: '/team-assets/anuradha.jpg',
  ...
  },
  {
    ...
    bio: 'Shivam Fouzdar is an Operations Manager with 7 years+ of experience. At Navigant, he manages UK and US operations, leading teams, improving key metrics like CSAT, and driving marketplace growth through process improvements and strong execution.',
  ...
  },
  {
    ...
    image: '/team-assets/kaushal.jpeg',
    bio: 'Kaushal is a Software Developer at Navigant who builds and maintains full-stack applications using the latest MERN technologies. He contributes to scalable solutions, improves performance, and delivers user-focused features through clean code and strong execution.',
  ...
  },
  {
    ...
    bio: 'Asheesh is a Software Developer specializing in Java backend development. At Navigant, he designs, builds, and maintains robust backend systems, contributing to scalable architectures, optimized performance, and reliable application functionality through clean, efficient code and strong execution.',
